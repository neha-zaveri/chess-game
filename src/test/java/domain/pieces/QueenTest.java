...
public class QueenTest {
    ...
    public void shouldAllowQueenInAllDirection() {
        ...
        List<String> possibleMoves = queen.getPossibleMoves(new Board(), new Cell(0, 0, "A1"));
    ...
    public void shouldAllowQueenInAllDirectionExtremeRightCorner() {
        Queen queen = new Queen();
        List<String> possibleMoves = queen.getPossibleMoves(new Board(), new Cell(7, 7, "H7"));
    ...
    public void shouldAllowQueenInAllDirectionCenter() {
        Queen queen = new Queen();
        List<String> possibleMoves = queen.getPossibleMoves(new Board(), new Cell(3, 4, "D5"));
