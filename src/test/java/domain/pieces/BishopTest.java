...
public class BishopTest {
    ...
    public void getPossibleMovesExtremeLeft() {
        ...
        List<String> possibleMoves = bishop.getPossibleMoves(new Board(), new Cell(0, 0, "A1"));
    ...
    public void getPossibleMovesExtremeRight() {
        Bishop bishop = new Bishop();
        List<String> possibleMoves = bishop.getPossibleMoves(new Board(), new Cell(7, 7, "H8"));
        assertEquals(7, possibleMoves.size());
    ...
    public void getPossibleMovesExtremeLeftTop(){
        Bishop bishop = new Bishop();
        List<String> possibleMoves = bishop.getPossibleMoves(new Board(), new Cell(7, 0, "H1"));
        assertEquals(7, possibleMoves.size());
    ...
    public void getPossibleMovesExtremeRightBottom(){
        Bishop bishop = new Bishop();
        List<String> possibleMoves = bishop.getPossibleMoves(new Board(), new Cell(0, 7, "A8"));
        assertEquals(7, possibleMoves.size());
    ...
    public void getPossibleMovesForCenter() {
        Bishop bishop = new Bishop();
        List<String> possibleMoves = bishop.getPossibleMoves(new Board(), new Cell(3, 4, "D5"));
