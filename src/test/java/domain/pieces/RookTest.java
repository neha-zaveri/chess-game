...
public class RookTest {
    ...
    public void getPossibleMovesExtremeLeft() {
        Rook rook = new Rook();
        List<String> possibleMoves = rook.getPossibleMoves(new Board().getCells(), new Cell(0, 0, "A1"));
    ...
    public void getPossibleMovesExtremeRight() {
        Rook rook = new Rook();
        List<String> possibleMoves = rook.getPossibleMoves(new Board().getCells(), new Cell(7, 7, "H8"));
        assertEquals(14, possibleMoves.size());
    }
    ...
    public void getPossibleMovesExtremeLeftTop() {
        Rook rook = new Rook();
        List<String> possibleMoves = rook.getPossibleMoves(new Board().getCells(), new Cell(7, 0, "H1"));
        assertEquals(14, possibleMoves.size());
    ...
    public void getPossibleMovesExtremeRightBottom() {
        Rook rook = new Rook();
        List<String> possibleMoves = rook.getPossibleMoves(new Board().getCells(), new Cell(0, 7, "A8"));
        assertEquals(14, possibleMoves.size());
    ...
    public void getPossibleMovesForCenter() {
        Rook rook = new Rook();
        List<String> possibleMoves = rook.getPossibleMoves(new Board().getCells(), new Cell(3, 4, "D5"));
        assertEquals(14, possibleMoves.size());
